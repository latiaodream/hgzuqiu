...
-H 'sec-ch-ua-mobile: ?1' \
-H 'sec-ch-ua-platform: "Android"' \
--data-raw 'p=FT_bet&uid=qf821vr52zm39199455l126653b0&ver=2025-10-16-fix342_120&langx=zh-cn&odd_f_type=H&golds=50&gid=8241331&gtype=FT&wtype=ROU&rtype=ROUC&chose_team=C&ioratio=0.91&con=2&ratio=-50&autoOdd=Y&timestamp=1760994711490&timestamp2=&isRB=Y&imp=N&ptype=&isYesterday=N&f=1R' ;
curl 'https://hga050.com/transform.php?ver=2025-10-16-fix342_120' \
-H 'Accept: */*' \
-H 'Accept-Language: en,en-US;q=0.9,zh-HK;q=0.8,zh;q=0.7,zh-CN;q=0.6' \
-H 'Cache-Control: no-cache' \
